...
/**
 * @author CodeFather Election Commissioner GUI for creating Ballots
 */
public class BallotPrompt extends JFrame implements ActionListener {
	...
	/**
	 * Creates interface for inputting ballot |Takes in title of race |Names of
	 * candidates |Generages Ballot on given input
	 **/
	...
	BallotPrompt() {
		...
		layout.setHorizontalGroup(
				layout.createSequentialGroup().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
						.addComponent(racePanel).addComponent(canPanel).addComponent(subPanel).addComponent(confirm).addComponent(finish)));
	...
	/**
	 * Action Commands | Checks if confirm has been pressed |Generates ballot
	 * based off input for ballot |Uses Race_Panel to compartmentalize race
	 * panel components
	 **/
